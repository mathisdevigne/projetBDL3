...
create table saison (
    ...
    constraint PK_SAISON primary key (ref),
...
create table contenu_type (
    ...
    constraint PK_CONTENU_TYPE primary key (refContenu, nomType),
    constraint FK_CONTENU_CONTENU_TYPE foreign key (refContenu) references contenu(ref)
);
